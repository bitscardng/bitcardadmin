    ...
    .map((data, index) => {
      return (
        <tr className="text-center hover:bg-sec" key={index}>
          ...
          <td className="p-1 px-2 text-xl font-thin duration-500 border">
            <p className="p-2 rounded-lg bg-active">Preview deposit details</p>
          </td>
          <td className="p-1 px-2 text-xl font-thin duration-500 border">
            {data.transDate} <span>{data.transTime}</span>
          </td>
          <td className="h-full gap-2 p-2 text-xl font-thin border ">
        ...
        <div className="flex justify-between w-full gap-8 overflow-x-auto">
          <div className="w-full overflow-x-auto">
            <div className="flex items-center gap-20 pb-2 text-center">
              ...
              />
              <p className="text-2xl font-bold text-center">Usd Deposit</p>
            </div>
