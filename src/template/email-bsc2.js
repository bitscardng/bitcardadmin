export const SendEmailBcTemplate2 = (content) => {
    return `
        <!DOCTYPE html>
													...
													<table class="image_block block-2" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 700px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/7996/hero-juneteenth.png" style="display: block; height: auto; border: 0; width: 100%;" width="700" alt="Hero Image" title="Hero Image" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
														...
														<tr>
															<td class="pad" style="padding-left:50px;padding-right:50px;">
																<div style="color:#373449;direction:ltr;font-family:'Ubuntu', Tahoma, Verdana, Segoe, sans-serif;font-size:18px;font-weight:400;letter-spacing:0px;line-height:150%;text-align:center;mso-line-height-alt:27px;">
																	<p data-pm-slice="1 1 []" style="margin: 0;">${content}</p>
																</div>
															</td>
														</tr>
													</table>
												...
												<td class="column column-1" width="100%" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; vertical-align: top; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;">
													<table class="image_block block-1" width="100%" border="0" cellpadding="0" cellspacing="0" role="presentation" style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;">
														<tr>
															<td class="pad" style="width:100%;">
																<div class="alignment" align="center" style="line-height:10px">
																	<div style="max-width: 700px;"><img src="https://d1oco4z2z1fhwp.cloudfront.net/templates/default/7996/hero-juneteenth-2.png" style="display: block; height: auto; border: 0; width: 100%;" width="700" alt="Reminder Illustration" title="Reminder Illustration" height="auto"></div>
																</div>
															</td>
														</tr>
													</table>
